sap.ui.define([
	...
	return BaseObject.extend("bookshop.app.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias bookshop.app.model.GroupSortState
		 */
		...
		/**
		 * Groups by stock, or resets the grouping for the key "None"
		 *
		 * @param sKey - the key of the field used for grouping
		 * @returns {sap.ui.model.Sorter[]} an array of sorters
		 */
		group: function (sKey) {
			...
			if (sKey === "stock") {
				...
				this._oViewModel.setProperty("/sortBy", "stock");

				aSorters.push(
					new Sorter("stock", false,
