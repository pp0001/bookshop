sap.ui.define([
	...
	opaTest("MasterList Filtering on stock less than 100", function (Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog("stock").
	...
	opaTest("MasterList Filtering on stock more than 100", function (Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
		and.iSelectListItemInViewSettingsDialog(">100 ").
		and.iPressOKInViewSelectionDialog();
	...
	opaTest("Grouping the master list and filtering it by the object identifier should deliver the initial list", function (Given, When,
		Then) {
		// Action
		When.onTheMasterPage.iGroupTheList().
